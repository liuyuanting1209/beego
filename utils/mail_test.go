...
func TestMail(t *testing.T) {
	config := `{"username":"liuyuanting1209@gmail.com","password":"liuyuanting1209","host":"smtp.gmail.com","port":587}`
	mail := NewEMail(config)
	if mail.Username != "liuyuanting1209@gmail.com" {
		t.Fatal("email parse get username error")
	}
	if mail.Password != "liuyuanting1209" {
