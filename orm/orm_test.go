...
func TestCRUD(t *testing.T) {
	...
	err = dORM.Read(u)
	throwFailNow(t, err)
	throwFail(t, AssertIs(u.UserName, "liuyuanting1209"))
	throwFail(t, AssertIs(u.Profile.ID, profile.ID))

	u = &User{UserName: "liuyuanting1209", Password: "pass"}
...
func TestInsertTestData(t *testing.T) {
	...
	user = NewUser()
	user.UserName = "liuyuanting1209"
	user.Email = "liuyuanting1209@gmail.com"
...
func TestOrderBy(t *testing.T) {
	...
	num, err = qs.OrderBy("-profile__age").Filter("user_name", "liuyuanting1209").Count()
	throwFail(t, err)
	throwFail(t, AssertIs(num, 1))
}
...
func TestAll(t *testing.T) {
	...
	throwFail(t, AssertIs(users[1].UserName, "liuyuanting1209"))
	...
	throwFailNow(t, AssertIs(users2[1].UserName, "liuyuanting1209"))
...
func TestValuesFlat(t *testing.T) {
	...
	if num == 3 {
		...
		throwFail(t, AssertIs(list[1], "liuyuanting1209"))
...
func TestRelatedSel(t *testing.T) {
	...
	throwFailNow(t, AssertIs(posts[1].User.UserName, "liuyuanting1209"))
	throwFailNow(t, AssertIs(posts[2].User.UserName, "liuyuanting1209"))
...
func TestReverseQuery(t *testing.T) {
	...
	profile = Profile{}
	err = dORM.QueryTable("user_profile").Filter("User__UserName", "liuyuanting1209").One(&profile)
	throwFailNow(t, err)
	throwFailNow(t, AssertIs(profile.Age, 30))
	...
	throwFailNow(t, err)
	throwFailNow(t, AssertIs(user.UserName, "liuyuanting1209"))

	user = User{}
	err = dORM.QueryTable("user").Filter("Posts__User__UserName", "liuyuanting1209").Limit(1).One(&user)
	throwFailNow(t, err)
	throwFailNow(t, AssertIs(user.UserName, "liuyuanting1209"))

	user = User{}
	err = dORM.QueryTable("user").Filter("Posts__User__UserName", "liuyuanting1209").RelatedSel().Limit(1).One(&user)
	throwFailNow(t, err)
	throwFailNow(t, AssertIs(user.UserName, "liuyuanting1209"))
	...
	num, err = dORM.QueryTable("tag").Filter("Posts__Post__Title", "Introduction").
		Filter("BestPost__User__UserName", "liuyuanting1209").All(&tags)
	throwFailNow(t, err)
	throwFailNow(t, AssertIs(num, 1))
	throwFailNow(t, AssertIs(tags[0].Name, "golang"))
	...
	tags = []*Tag{}
	num, err = dORM.QueryTable("tag").Filter("Posts__Post__Title", "Introduction").
		Filter("BestPost__User__UserName", "liuyuanting1209").RelatedSel().All(&tags)
	throwFailNow(t, err)
	throwFailNow(t, AssertIs(num, 1))
	throwFailNow(t, AssertIs(tags[0].Name, "golang"))
	...
	throwFailNow(t, AssertIs(tags[0].BestPost.User.UserName, "liuyuanting1209"))
}
...
func TestLoadRelated(t *testing.T) {
	...
	throwFailNow(t, AssertIs(num, 2))
	throwFailNow(t, AssertIs(len(user.Posts), 2))
	throwFailNow(t, AssertIs(user.Posts[0].User.UserName, "liuyuanting1209"))
	...
	throwFailNow(t, AssertIs(profile.User.UserName, "liuyuanting1209"))
	...
	throwFailNow(t, AssertIs(post.User.UserName, "liuyuanting1209"))
	...
	throwFailNow(t, AssertIs(post.Tags[0].BestPost.User.UserName, "liuyuanting1209"))
...
func TestQueryRows(t *testing.T) {
	...
	throwFailNow(t, AssertIs(usernames[1], "liuyuanting1209"))
	...
	throwFailNow(t, AssertIs(l[1].UserName, "liuyuanting1209"))
