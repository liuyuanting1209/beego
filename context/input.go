...
// like /?id=123&isok=true&ft=1.2&ol[0]=1&ol[1]=2&ul[]=str&ul[]=array&user.Name=liuyuanting1209
...
// user struct{Name}  beegoInput.Bind(&user, "user")  user == {Name:"liuyuanting1209"}
